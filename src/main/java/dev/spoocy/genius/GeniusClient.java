...
public interface GeniusClient extends Closeable {
     ...
     * <p>
     * <strong>URL should look like this</strong>: {@code https://genius.com/Sia-chandelier-lyrics} <br />
     * <strong>URLs like this might not work</strong>: {@code https://genius.com/songs/378195}
     *
     * @see Song#getUrl() Gets the preferred URL.
     *
     *
